...
6. __Write design doc__ — save to `docs/superpowers/specs/YYYY-MM-DD-<topic>-design.md` and commit
7. __Spec review loop__ — dispatch spec-document-reviewer subagent with precisely crafted review context (never your session history); fix issues and re-dispatch until approved (max 3 iterations, then surface to human)
