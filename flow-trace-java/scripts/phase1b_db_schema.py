...
Merges all into db-schema.json with lookup dictionary for Phase 3 endpoint identification.
"""
...
def do_phase1b():
    ...
    # Build lookup for Phase 3: "MapperClass.methodName" -> {table, operation}
    lookup = {}
    for t in merged:
    ...
    # Output 2: lookup (for Phase 3 subagent consumption)
    lookup_output = {
        "version": "2.0",
